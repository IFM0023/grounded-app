  ...
  g.GROUNDED_HOME_WEEKLY_THEMES_52 = [
    // ── JANUARY ──
    {
      ...
      days: [
        ...
        { focus: 'Intention', verse: { text: 'Commit to the Lord whatever you do, and he will establish your plans.', reference: 'Proverbs 16:3' }, prompt: 'Where could you hold your plans a little more loosely today?', reflection: 'Intention moves slower than panic—and that can be a kindness. It is one honest next step instead of fixing everything before you move.' },
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Receive', verse: { text: 'The Lord gives strength to his people; the Lord blesses his people with peace.', reference: 'Psalm 29:11' }, prompt: 'What would it look like to receive care without auditing whether you earned it?', reflection: 'Receiving care can feel risky if you are used to earning everything. Let today be a small practice of letting kindness land without measuring whether you deserved it.' }
      ]
    },
    {
      ...
      days: [
        ...
        { focus: 'Chosen', verse: { text: 'But you are a chosen people, a royal priesthood, a holy nation, God\'s special possession.', reference: '1 Peter 2:9' }, prompt: 'If “chosen” were true today, not theory, what would feel different by tonight?', reflection: 'Chosen is not a trophy word. It is permission to rest in a belonging you did not earn.' },
        { focus: 'Enough', verse: { text: 'The Lord your God is with you, the Mighty Warrior who saves. He will take great delight in you.', reference: 'Zephaniah 3:17' }, prompt: 'Where does your inner voice sound more like a critic than a friend—and what is that voice trying to protect?', reflection: 'Enough is not the absence of desire. It is the quiet relief of not having to prove you belong in order to breathe.' }
      ]
    },
    {
      ...
      days: [
        ...
        { focus: 'Doubt', verse: { text: "Immediately the boy's father exclaimed, 'I do believe; help me overcome my unbelief!'", reference: 'Mark 9:24' }, prompt: 'What doubt feels too risky to say out loud? Try saying it to God in plain words.', reflection: 'Doubt is not the opposite of faith. It is often the doorway where faith stops pretending and starts becoming real.' },
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Presence', verse: { text: 'Even though I walk through the darkest valley, I will fear no evil, for you are with me.', reference: 'Psalm 23:4' }, prompt: 'When answers are thin, what shifts if you notice presence before explanation?', reflection: 'The valley is not proof you took a wrong turn. It is often where presence becomes undeniable because answers are thin.' },
    ...
    },
    {
      ...
      days: [
        { focus: 'Acknowledge', verse: { text: 'He heals the brokenhearted and binds up their wounds.', reference: 'Psalm 147:3' }, prompt: 'What hurt have you been rushing past that still asks for your attention?', reflection: 'Acknowledging pain is not indulgence. It is the first step out of the exhausting pressure to seem fine.' },
    ...
    },
    {
      ...
      days: [
        { focus: 'Control', verse: { text: 'Cast all your anxiety on him because he cares for you.', reference: '1 Peter 5:7' }, prompt: 'What are you holding tightly right now—a person, an outcome, or a picture of how life should look?', reflection: 'Control promises safety and delivers exhaustion. Open hands are not careless—they are honest about what was never yours to guarantee.' },
    ...
    },
    {
      ...
      days: [
        { focus: 'Give', verse: { text: 'Each of you should give what you have decided in your heart to give, not reluctantly or under compulsion, for God loves a cheerful giver.', reference: '2 Corinthians 9:7' }, prompt: 'Where does giving feel easy—and where does your hand tighten? No judgment, just notice.', reflection: 'Giving is not pretending you have it all together. It is admitting you have enough to share because you are human, not infinite.' },
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Faithfulness', verse: { text: 'Whatever you do, work at it with all your heart, as working for the Lord, not for human masters.', reference: 'Colossians 3:23' }, prompt: 'What would change if today’s tasks were a quiet offering—not something you have to prove?', reflection: 'Faithfulness in ordinary work is not small to God. He sees the hidden faithfulness no one else clocks.' },
        ...
        { focus: 'Enough', verse: { text: 'Better one handful with tranquility than two handfuls with toil and chasing after the wind.', reference: 'Ecclesiastes 4:6' }, prompt: 'Where are you trying to prove you matter by doing more? What might “enough” look like if you believed you already belong?', reflection: 'Trying to earn your place can feel loud. Enough is the quieter truth: you matter before the next thing gets done.' },
        { focus: 'Fruit', verse: { text: 'I am the vine; you are the branches. If you remain in me and I in you, you will bear much fruit; apart from me you can do nothing.', reference: 'John 15:5' }, prompt: 'Are you moving through today from a place of peace—or mostly from pressure?', reflection: 'Fruit grows from staying near the vine, not from striving. Remaining is the part you cannot skip.' }
      ]
    },
    {
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Fruitful', verse: { text: 'Remain in me, as I also remain in you. No branch can bear fruit by itself; it must remain in the vine.', reference: 'John 15:4' }, prompt: 'What helps you stay connected to God this month—in plain, practical terms?', reflection: 'What grows in your life often shows what you are rooted in. Stay close; the branch does not force the vine.' }
      ]
    },
    {
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Delight', verse: { text: 'Take delight in the Lord, and he will give you the desires of your heart.', reference: 'Psalm 37:4' }, prompt: 'What lights you up when no one is watching—and when did you last make room for it?', reflection: 'Delight is not careless joy. It is remembering your heart was made for more than just getting through the day.' },
    ...
    // ── JULY ──
    {
      ...
      days: [
        ...
        { focus: 'Light', verse: { text: 'You are the light of the world. A town built on a hill cannot be hidden.', reference: 'Matthew 5:14' }, prompt: 'What would “light” look like in your actual Tuesday—in one concrete behavior?', reflection: 'Light is one small choice that matches what you believe—no spotlight required.' },
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Meek', verse: { text: 'Blessed are the meek, for they will inherit the earth.', reference: 'Matthew 5:5' }, prompt: 'Meekness is strength with a gentle grip. Where could you use more of that this week?', reflection: 'Meekness is strength under control—Jesus showed it in how he moved toward the bruised without needing to win every room.' }
      ]
    },
    {
    ...
    },
    {
      ...
      subtitle: 'Loss asks for honesty before it asks for answers',
      days: [
    ...
    },
    {
      ...
      days: [
        ...
        { focus: 'Testimony', verse: { text: 'They triumphed over him by the blood of the Lamb and by the word of their testimony.', reference: 'Revelation 12:11' }, prompt: 'What part of your story might encourage one person if you told it simply?', reflection: 'Testimony is not a speech you rehearse. It is one true sentence that might light a match in someone else\'s dark room.' },
        { focus: 'New', verse: { text: "He who was seated on the throne said, 'I am making everything new!'", reference: 'Revelation 21:5' }, prompt: 'If God is making things new—including you—what is one area you would hand him first?', reflection: 'New includes you—not a fantasy version, you. Hand him the part you are tired of hiding.' }
      ]
    },
